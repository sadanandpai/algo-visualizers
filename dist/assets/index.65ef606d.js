...
`,Y=a.memo((function({array:e,sortFunction:t,sortingAlgorithmName:r}){const[n,l]=a.useState([-1,-1]),[o,i]=a.useState([-1,-1]),s=a.useRef([]),c=a.useRef([]),u=a.useRef(-1),d=a.useRef(0),m=a.useRef(0),p=a.useRef(!1),f=a.useRef(!1),g=k((e=>e.markSortngDone)),y=a.useRef(""),x=a.useRef(null);async function h(){s.current=[...e],c.current=[],u.current=-1,d.current=0,m.current=0,p.current=!1,l([-1,-1]),i([-1,-1]),x.current="MergeSort"===r?await t(s.current,E,v,S):await t(s.current,b,v,S)}async function b(e,t){let r=s.current[e];s.current[e]=s.current[t],s.current[t]=r,l([e,t]),u.current=-1,d.current+=1,await w(q)}async function E(e,t){e!==t&&(d.current+=1,i([-1,-1]),l([e,t]),await w(q))}async function v(e,t){l([-1,-1]),m.current+=1,u.current=t,i(e),await w(Q)}function S(...e){c.current.push(...e)}a.useEffect((()=>(y.current=k.getState().progress,k.subscribe((e=>{y.current=e,"start"===y.current&&async function(){var e;let t={done:!1};for(;!(null==t?void 0:t.done)&&"start"===y.current&&!f.current;)t=await(null==(e=x.current)?void 0:e.next());if(f.current)return;!p.current&&(null==t?void 0:t.done)&&(p.current=!0,u.current=-1,l([-1,-1]),i([-1,-1]),g())}(),"reset"===y.current&&h()}),(e=>e.progress)),()=>{f.current=!0})),[]),a.useEffect((()=>{h()}),[e]);const $=a.createElement(D,{array:s.current,source:n[0],destination:n[1],hightlightedIndices:o,sortedIndices:c.current}),C=a.createElement(O,{array:s.current,source:n[0],destination:n[1],pivot:u.current,highlightIndices:o,sortedIndices:c.current});return a.createElement(J,null,a.createElement(K,null,a.createElement("strong",null,r),a.createElement(X,null,a.createElement("span",null,"Time:"),a.createElement("strong",null,a.createElement(H,{isAlgoExecutionOver:p.current})))),"MergeSort"===r?$:C,a.createElement(W,{swapCount:d.current,comparisionCount:m.current}))})),Z=c.div`
  display: flex;
  flex-wrap: wrap;
  justify-content: center;
  max-width: 100%;
